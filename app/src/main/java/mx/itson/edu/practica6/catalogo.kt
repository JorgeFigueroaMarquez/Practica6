...
class catalogo : AppCompatActivity() {
    ...
    fun cargarSeries(){
        series.add(Pelicula("Avatar: La leyenda de Aang", R.drawable.ant, R.drawable.ant2, "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
        ...
        series.add(Pelicula("El monstruo de la vieja de Seúl", R.drawable.elmonstruo, R.drawable.elmonstruovieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
